...
public class ZKClient_01_demo {
    public static void main(String[] args) throws IOException, KeeperException, InterruptedException {
        // 创建一个zk客户端
        ZooKeeper zk = new ZooKeeper("10.17.4.62:2181", 30000, new Watcher() {
            @Override
        ...
        // 创建一个持久有序的节点 /suntest，内容为haha
        zk.create("/suntest", "haha".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);

        // 获取数据开启监听
        byte[] zkData = zk.getData("/AA", true, null);
